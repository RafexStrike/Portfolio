...
```css
@import url('https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;600&family=Playfair+Display:wght@600;700&display=swap');
@import "tailwindcss";
...
body {
  background: #f5f5f5;
  color: #000;
  font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'IBM Plex Mono', monospace;
  font-size: 14px;
  line-height: 1.5;
  position: relative;
  overflow-x: hidden;
...
body::before {
  ...
  height: 100%;
  background-image: 
    radial-gradient(2px 2px at 20px 30px, #ddd, rgba(0,0,0,0)),
